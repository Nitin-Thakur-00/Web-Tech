...
This experiment covers the fundamentals of PHP, including configuration, basic output, data types, and system information rendering.
...
1.  Open your terminal in the `Exp 8/Excercise X` directory.
